...
use crate::fs::syscall::{sys_close, sys_ftruncate, sys_lseek, sys_mount, sys_open, sys_pivot_root, sys_read, sys_readdir, sys_truncate, sys_umount, sys_write};
...
syscall_table! {
    ...
    ReadDir = 27 => sys_readdir,
    // Filesystem operations
    Mount = 30 => sys_mount,
    Umount = 31 => sys_umount,
    PivotRoot = 32 => sys_pivot_root,
}
