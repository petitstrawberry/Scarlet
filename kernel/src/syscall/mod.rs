...
//! - VfsOpen (400), VfsRemove (401), VfsCreateFile (402), VfsCreateDirectory (403), VfsChangeDirectory (404), VfsTruncate (405), VfsCreateSymlink (406), VfsReadlink (407), VfsGetCwdPath (408), VfsRename (409), VfsMetadata (410), VfsCreateHardlink (411), VfsSymlinkMetadata (412)
//!
...
use crate::fs::vfs_v2::syscall::{
    ...
    sys_vfs_rename, sys_vfs_symlink_metadata, sys_vfs_truncate,
};
...
use crate::task::syscall::{
    ...
    sys_exit, sys_exit_group, sys_get_cpu_debug_info, sys_get_cpu_usage_info,
    sys_get_process_group_id, sys_get_scheduler_attr, sys_get_scheduler_state, sys_get_session_id,
    sys_get_task_cpu_affinity, sys_get_task_deadline, sys_get_task_debug_info,
    sys_get_task_info_count, sys_get_task_info_list, sys_get_task_nice, sys_get_task_util_min,
    sys_get_tls, sys_getchar, sys_getpid, sys_getppid, sys_kill, sys_monotonic_time, sys_putchar,
    sys_register_abi_zone, sys_sbrk, sys_set_process_group, sys_set_scheduler_attr,
...
syscall_table! {
    ...
    GetCpuDebugInfo = 997 => sys_get_cpu_debug_info, // Per-CPU timer/breadcrumb snapshot
