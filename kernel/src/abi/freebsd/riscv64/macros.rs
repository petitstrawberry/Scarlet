/// Define syscall table and syscall handler for freebsd-riscv64
///
/// # Example
/// ```
/// syscall_table! {
///    Invalid = 0 => |_:&mut FreeBsdRiscv64Abi, _: &mut Trapframe| {
///       0
///   },
...
macro_rules! syscall_table {
    ( $( $name:ident = $num:expr => $func:expr ),* $(,)? ) => {
        ...
        pub fn syscall_handler(abi: &mut crate::abi::freebsd::riscv64::FreeBsdRiscv64Abi, trapframe: &mut crate::arch::Trapframe) -> Result<usize, &'static str> {
            let syscall_number = trapframe.get_arg(7);
            // crate::println!("FreeBSD Syscall number: {}", syscall_number);
            if syscall_number == 0 {
