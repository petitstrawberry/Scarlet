use crate::{
    abi::linux::aarch64::LinuxAarch64Abi, arch::Trapframe, ipc::pipe::UnidirectionalPipe,
    task::mytask,
};
...
pub fn sys_socket(abi: &mut LinuxAarch64Abi, trapframe: &mut Trapframe) -> usize {
...
pub fn sys_bind(_abi: &mut LinuxAarch64Abi, trapframe: &mut Trapframe) -> usize {
    let task = match mytask() {
        Some(t) => t,
        None => return usize::MAX,
    };
...
/// - 0 on success
/// - usize::MAX (Linux -1) indicating failure
pub fn sys_listen(_abi: &mut LinuxAarch64Abi, trapframe: &mut Trapframe) -> usize {
    let task = match mytask() {
        Some(t) => t,
        None => return usize::MAX,
    };
...
/// - usize::MAX (Linux -1) indicating failure
pub fn sys_accept(abi: &mut LinuxAarch64Abi, trapframe: &mut Trapframe) -> usize {
    let task = match mytask() {
        Some(t) => t,
        None => return usize::MAX,
    };
...
/// - 0 on success
/// - usize::MAX (Linux -1) indicating failure
pub fn sys_connect(_abi: &mut LinuxAarch64Abi, trapframe: &mut Trapframe) -> usize {
    let task = match mytask() {
        Some(t) => t,
        None => return usize::MAX,
    };
...
/// - 0 on success
/// - usize::MAX (Linux -1) indicating failure
pub fn sys_getsockname(_abi: &mut LinuxAarch64Abi, trapframe: &mut Trapframe) -> usize {
    let task = match mytask() {
        Some(t) => t,
        None => return usize::MAX,
    };
...
/// - 0 on success
/// - usize::MAX (Linux -1) indicating failure
pub fn sys_getsockopt(_abi: &mut LinuxAarch64Abi, trapframe: &mut Trapframe) -> usize {
    let task = match mytask() {
        Some(t) => t,
        None => return usize::MAX,
    };
...
/// - 0 on success
/// - usize::MAX (Linux -1) indicating failure
pub fn sys_setsockopt(_abi: &mut LinuxAarch64Abi, trapframe: &mut Trapframe) -> usize {
    let task = match mytask() {
        Some(t) => t,
        None => return usize::MAX,
    };
