...
pub fn sys_rt_sigaction(abi: &mut LinuxAarch64Abi, trapframe: &mut Trapframe) -> usize {
...
pub fn sys_rt_sigprocmask(abi: &mut LinuxAarch64Abi, trapframe: &mut Trapframe) -> usize {
    let task = mytask().unwrap();
...
pub fn deliver_signal_to_task(abi: &LinuxAarch64Abi, signal: LinuxSignal) {
...
pub fn get_next_pending_signal(abi: &LinuxAarch64Abi) -> Option<LinuxSignal> {
