...
// pub fn sys_fork(_abi: &mut LinuxAarch64Abi, trapframe: &mut Trapframe) -> usize {
...
pub fn sys_set_tid_address(abi: &mut LinuxAarch64Abi, trapframe: &mut Trapframe) -> usize {
...
pub fn sys_exit(_abi: &mut LinuxAarch64Abi, trapframe: &mut Trapframe) -> usize {
    let task = mytask().unwrap();
...
pub fn sys_exit_group(_abi: &mut LinuxAarch64Abi, trapframe: &mut Trapframe) -> usize {
    let task = mytask().unwrap();
    task.vcpu.store(trapframe);
    let exit_code = trapframe.get_arg(0) as i32;
    task.exit(exit_code);
...
pub fn sys_set_robust_list(abi: &mut LinuxAarch64Abi, trapframe: &mut Trapframe) -> usize {
    let task = mytask().unwrap();
...
// pub fn sys_wait(_abi: &mut LinuxAarch64Abi, trapframe: &mut Trapframe) -> usize {
//     let task = mytask().unwrap();
...
#[allow(dead_code)]
pub fn sys_kill(_abi: &mut LinuxAarch64Abi, _trapframe: &mut Trapframe) -> usize {
...
#[allow(dead_code)]
pub fn sys_sbrk(_abi: &mut LinuxAarch64Abi, trapframe: &mut Trapframe) -> usize {
    let task = mytask().unwrap();
...
pub fn sys_brk(_abi: &mut LinuxAarch64Abi, trapframe: &mut Trapframe) -> usize {
    let task = mytask().unwrap();
...
pub fn sys_getpid(_abi: &mut LinuxAarch64Abi, trapframe: &mut Trapframe) -> usize {
    let task = mytask().unwrap();
...
pub fn sys_getppid(_abi: &mut LinuxAarch64Abi, trapframe: &mut Trapframe) -> usize {
    let task = mytask().unwrap();
    trapframe.increment_pc_next(task);
...
pub fn sys_gettid(_abi: &mut LinuxAarch64Abi, trapframe: &mut Trapframe) -> usize {
    let task = mytask().unwrap();
    trapframe.increment_pc_next(task);
    task.get_id()
}

pub fn sys_setpgid(_abi: &mut LinuxAarch64Abi, trapframe: &mut Trapframe) -> usize {
    let task = mytask().unwrap();
...
pub fn sys_getpgid(_abi: &mut LinuxAarch64Abi, trapframe: &mut Trapframe) -> usize {
    let task = mytask().unwrap();
    let _pid = trapframe.get_arg(0);
    trapframe.increment_pc_next(task);
...
pub fn sys_prlimit64(_abi: &mut LinuxAarch64Abi, trapframe: &mut Trapframe) -> usize {
    let task = mytask().unwrap();
...
pub fn sys_getuid(_abi: &mut LinuxAarch64Abi, trapframe: &mut Trapframe) -> usize {
    let task = mytask().unwrap();
    trapframe.increment_pc_next(task);
...
pub fn sys_geteuid(_abi: &mut LinuxAarch64Abi, trapframe: &mut Trapframe) -> usize {
    let task = mytask().unwrap();
    trapframe.increment_pc_next(task);
...
pub fn sys_getgid(_abi: &mut LinuxAarch64Abi, trapframe: &mut Trapframe) -> usize {
    let task = mytask().unwrap();
    trapframe.increment_pc_next(task);
...
pub fn sys_getegid(_abi: &mut LinuxAarch64Abi, trapframe: &mut Trapframe) -> usize {
    let task = mytask().unwrap();
    trapframe.increment_pc_next(task);
...
pub fn sys_uname(_abi: &mut LinuxAarch64Abi, trapframe: &mut Trapframe) -> usize {
    let task = mytask().unwrap();
...
pub fn sys_clone(abi: &mut LinuxAarch64Abi, trapframe: &mut Trapframe) -> usize {
...
/// Returns:
/// - 0 on success
pub fn sys_setgid(_abi: &mut LinuxAarch64Abi, trapframe: &mut Trapframe) -> usize {
...
/// Returns:
/// - 0 on success
pub fn sys_setuid(_abi: &mut LinuxAarch64Abi, trapframe: &mut Trapframe) -> usize {
    let task = match mytask() {
        Some(t) => t,
        None => return usize::MAX - 1, // -EPERM
    };
...
pub fn sys_wait4(_abi: &mut LinuxAarch64Abi, trapframe: &mut Trapframe) -> usize {
...
pub fn sys_membarrier(_abi: &mut LinuxAarch64Abi, trapframe: &mut Trapframe) -> usize {
    let task = match mytask() {
        Some(t) => t,
        None => return usize::MAX - 1, // -EPERM
    };
