//! OS compatibility layer for SAS client.
...
#[cfg(feature = "std")]
pub use scarlet_os::handle::capability::memory_mapping::prot;
#[cfg(feature = "std")]
...
#[cfg(not(feature = "std"))]
pub use scarlet_std::handle::capability::memory_mapping::prot;
#[cfg(not(feature = "std"))]
