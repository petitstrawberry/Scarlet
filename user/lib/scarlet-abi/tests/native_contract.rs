...
fn native_syscall_numbers() {
    ...
    check_numbers! {
        ...
        HandleClose = 102, HandleDuplicate = 103,
        HandleGetFlags = 104, HandleSetFlags = 105,
        HandleCloseWithStatus = 106, HandleDuplicateWithStatus = 107,
        HandleGetDescriptorFlags = 108, HandleSetDescriptorFlags = 109,
        HandleControl = 110,
        StreamRead = 200, StreamWrite = 201, Poll = 202, FileSeek = 300,
        StreamReadWithStatus = 203, StreamWriteWithStatus = 204,
        FileTruncate = 301, FileMetadata = 302, FileSetTimes = 303, FileSync = 304,
        FileSeekWithStatus = 305, FileTruncateWithStatus = 306,
        FileReadAtWithStatus = 308, FileWriteAtWithStatus = 309, FileLock = 310,
        ...
        VfsOpenAt = 417, VfsRemoveWithStatus = 418,
