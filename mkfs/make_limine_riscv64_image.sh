...
BOOT_IMAGE="${BOOT_IMAGE:-$DIST_DIR/limine-riscv64-boot.img}"
KERNEL_ELF="${KERNEL_ELF:-../projects/riscv64-limine-full/target/riscv64gc-unknown-none-elf/debug/scarlet}"
